...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\USER.DESKTOP-SS35GP9\Desktop\Django_project\Django_Task'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\USER.DESKTOP-SS35GP9\Desktop\Django_project\Django_Task\Scripts\deactivate.nu'
